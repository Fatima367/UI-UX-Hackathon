...
export default function RecommendationCar() {
    return (
      <div className="p-6 mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-20 mb-8">
        <div className="flex overflow-hidden flex-col p-6 bg-white rounded-xl min-w-[240px] w-[304px] max-md:px-5 relative border border-gray-50">
          ...
          <div className="flex gap-3 mt-8 w-full items-center justify-stretch">
            <div className="flex flex-col font-bold text-slate-900">
              ...
              <div className="mt-1 text-sm text-slate-400 line-through">$80.00</div>
            </div>
            <button
        ...
        <div className="flex overflow-hidden flex-col p-6 bg-white rounded-xl min-w-[240px] w-[304px] max-md:px-5 relative border border-gray-50">
          ...
          <Image
            ...
            src="/images/Car7.png"
            alt="MG ZX Exclusice"
            className="object-contain self-center mt-16 max-w-full aspect-[3.18] max-md:mt-10"
          />
          <div className="flex gap-4 items-start mt-16 text-sm font-medium leading-5 text-slate-400 max-md:mt-10">
            <div className="flex gap-1.5 items-start tracking-tight whitespace-nowrap">
              <Image
        ...
        <div className="flex items-center justify-center my-[64px]">
         <button className="rounded space-x-2 px-5 bg-[#3563E9] text-[16px] font-semibold text-white
           h-[44px] w-[156px]" >
                Show more car
         </button>
        </div>
